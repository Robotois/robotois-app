    ...
    <div className="popover-container">
      <div className="card">
        ...
        <div className="card-body">
          <dl>
            <dt>Sensores</dt>
            <dd>Para mostrar la medición de un sensor
              se debe incluir el código <code>{'${value}'}</code></dd>
            <dt>Estados Digitales</dt>
            <dd>Para mostrar el estado binario <mark>(ON|OFF)</mark> de una entrada
              digital se debe incluir el código <code>{'${status}'}</code></dd>
          </dl>
        </div>
      </div>
    </div>
